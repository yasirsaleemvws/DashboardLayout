...
export const GET__PARKING_LIST = async (page: any, rowsPerPage: any) => {
    try {
...
export const POST_PASSWORD = async (data: any) => {
    try {
...
export const POST_COMPANY_PROFILE = async (data: any) => {
    try {
...
export const POST_PROFILE = async (data: any) => {
    try {
...
export const POST_NOTIFICATION_PREFERENCES = async (data: any) => {
    try {
...
export const POST_DISPLAY_MODE = async (data: any) => {
    try {
...
export const GET_TEAM_MEMBERS = async (page: any, limit: any, search: any, sort: any) => {
    try {
...
export const POST_TEAM_MEMBER = async (data: any) => {
    try {
...
export const POST_DELETE_TEAM_MEMBER = async (data: any) => {
    try {
...
export const POST_MEMBER_STATUS = async (data: any) => {
    try {
...
export const POST_PARKER_MEMBER_STATUS = async (data: any) => {
    try {
        const response = await PrivateAxiosInstance.post(`companies/update-member-status`, data);
        return response.data;
    } catch (error: any) {
...
export const GET_PARKER_MEMBERS = async (page: any, limit: any, search: any, sort: any, type: any) => {
    try {
...
export const GET_PARKING_AREAS_SLOTS = async (id: any) => {
    try {
...
export const POST_PARKING_AREAS = async (data: any) => {
    try {
...
export const POST_MANUAL_PARKER = async (data: any) => {
    try {
...
export const GET_MANUAL_PARKER = async (page: any, limit: any, search: any, sort: any) => {
    try {
...
export const POST_UPDATE_MANUAL_PARKER = async (data: any) => {
    try {
