            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
                ...
                <div className="relative flex-grow md:flex-grow-0">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 w-full md:w-52 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                </div>

                {/* Filter Button */}
                <button
                    className="p-2 border rounded-md hover:bg-gray-200 text-xl flex-shrink-0"
                ...
                {/* Export Button */}
                <button
                    className="p-2 border rounded-md hover:bg-gray-200 flex items-center flex-shrink-0"
                >
